...
class ComentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coment" do
    assert_difference("Coment.count") do
      post coments_url, params: { coment: { boor_id: @coment.boor_id, message: @coment.message, title: @coment.title, user_id: @coment.user_id } }, as: :json
    end
  ...
  test "should update coment" do
    patch coment_url(@coment), params: { coment: { boor_id: @coment.boor_id, message: @coment.message, title: @coment.title, user_id: @coment.user_id } }, as: :json
    assert_response :success
  end
